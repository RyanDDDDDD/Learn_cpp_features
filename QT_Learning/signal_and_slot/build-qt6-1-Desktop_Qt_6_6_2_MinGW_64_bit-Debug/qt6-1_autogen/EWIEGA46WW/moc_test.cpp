...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSChildENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSChildENDCLASS = QtMocHelpers::stringData(
    "Child"
);
#else  // !QT_MOC_HAS_STRING_DATA
struct qt_meta_stringdata_CLASSChildENDCLASS_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSChildENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSChildENDCLASS_t qt_meta_stringdata_CLASSChildENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChildENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Child::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSChildENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSChildENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChildENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSChildENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
